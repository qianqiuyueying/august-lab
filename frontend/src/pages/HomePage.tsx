...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <motion.section style={{ opacity: heroOpacity, y: heroY }} className="relative -mx-4 flex min-h-[70vh] items-center overflow-hidden rounded-lg px-6 py-24 sm:-mx-6 lg:-mx-8 sm:px-10 sm:py-32 lg:px-14">
        ...
        {/* Hero glass card */}
        <TiltCard className="relative z-10 mx-auto w-full max-w-5xl">
