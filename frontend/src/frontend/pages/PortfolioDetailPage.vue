  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-if="loading" class="min-h-screen flex items-center justify-center">
      <div class="loading-responsive">
        ...
        <p class="text-gray-500 mt-4">加载作品详情中...</p>
      </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
          ...
          <div class="relative">
            <ResponsiveImage
              ...
              loading="eager"
            />
            <div v-else class="w-full h-64 md:h-96 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
            ...
            <div v-if="portfolio.is_featured" class="absolute top-4 right-4">
              <div class="bg-primary-600 text-white px-3 py-1 rounded-full text-sm font-medium shadow-lg">
          ...
          <div class="p-6 md:p-8">
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              <!-- 左侧：标题和描述 -->
              <div class="flex-1">
                <h1 class="heading-1 mb-4">{{ portfolio.title }}</h1>
                
                <p v-if="portfolio.description" class="text-responsive-lg text-gray-600 leading-relaxed mb-6">
                  {{ portfolio.description }}
                </p>
                
                <!-- 技术栈 -->
                <div class="mb-6">
                  <h3 class="heading-5 mb-3">技术栈</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
              ...
              <div class="prose max-w-none">
                ...
                <h3 class="heading-5 mt-8 mb-4">技术亮点</h3>
            ...
            <!-- 开发历程 -->
            <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
              <h2 class="heading-3 mb-6">开发历程</h2>
              <div class="space-y-6">
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-900 mb-2">需求分析与设计</h4>
                    <p class="text-gray-600 text-sm">深入分析用户需求，制定技术方案和设计规范</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-900 mb-2">技术选型与架构</h4>
                    <p class="text-gray-600 text-sm">选择合适的技术栈，设计可扩展的系统架构</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-900 mb-2">开发与测试</h4>
                    <p class="text-gray-600 text-sm">迭代开发，持续集成，确保代码质量和功能完整性</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-900 mb-2">部署与优化</h4>
                    <p class="text-gray-600 text-sm">项目上线部署，性能监控和持续优化</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
              <h3 class="heading-5 mb-4">项目信息</h3>
              <div class="space-y-3 text-sm">
                <div class="flex justify-between">
                  <span class="text-gray-500">创建时间</span>
                  <span class="text-gray-900">{{ formatDate(portfolio.created_at) }}</span>
                </div>
                <div class="flex justify-between">
                  <span class="text-gray-500">更新时间</span>
                  <span class="text-gray-900">{{ formatDate(portfolio.updated_at) }}</span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between">
                  <span class="text-gray-500">技术数量</span>
                  <span class="text-gray-900">{{ portfolio.tech_stack.length }} 项</span>
                </div>
              </div>
            </div>

            <!-- 相关链接 -->
            <div v-if="portfolio.project_url || portfolio.github_url" class="bg-white rounded-xl shadow-sm p-6">
              <h3 class="heading-5 mb-4">相关链接</h3>
              <div class="space-y-3">
                <a 
                  v-if="portfolio.project_url"
                  :href="portfolio.project_url"
            ...
            <!-- 分享 -->
            <div class="bg-white rounded-xl shadow-sm p-6">
              <h3 class="heading-5 mb-4">分享项目</h3>
